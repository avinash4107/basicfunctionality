			...
			<div class="row row-offcanvas row-offcanvas-left">
				...
				<div class="sidebar-offcanvas" id="sidebar">
					...
					<ul class="nav" id="myMenu">
						...
						<li id="item4"><a href="/salarystructure"><i class="fa fa-money"></i> <span
								class="collapse in hidden-xs">Salary Structure</span></a></li>
						<li id="item5"><a href="/saveDeductionInfo"><i class="fa fa-minus"></i> <span
								class="collapse in hidden-xs">Deductions</span></a></li>
					...
					<div class="user-table">
						...
						<div class="form-fields">
							<form:form name="validation" role="form"
								modelAttribute="salaryInfo" action="/saveSaloryInfo"
